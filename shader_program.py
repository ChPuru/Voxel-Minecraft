...
class ShaderProgram:
    ...
    def get_program(self, shader_name):
        with open(f'voxel/VoxelEngine/P10_TerrainGeneration/shaders/{shader_name}.vert') as file:
            vertex_shader = file.read()

        with open(f'voxel/VoxelEngine/P10_TerrainGeneration/shaders/{shader_name}.frag') as file:
